                ...
                <>
                    ...
                    <div className="modal-dialog">
                        ...
                        <div className="modal-header">
                            <h5 className="modal-title" id="addClientModalLabel">New Project</h5>
                        ...
                        <div className="modal-body">
                            <form onSubmit={onSubmit}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <textarea type='email' className="form-control" id='description' value={ description} onChange={ (e) => setDescription(e.target.value)}/>
                                </div>
                                <div className="mb-3">
